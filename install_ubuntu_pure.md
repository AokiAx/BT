...
```bash
DEFAULT_PURE_RAW_BASE="https://raw.githubusercontent.com/你的用户名/你的仓库/main"
```
...
```bash
DEFAULT_PANEL_ZIP_URL="https://github.com/你的用户名/你的仓库/releases/download/pure-v1/panel-pure.zip"
```
...
# 或临时指定仓库，不改脚本默认值：
export PURE_RAW_BASE=https://raw.githubusercontent.com/你的用户名/你的仓库/main
