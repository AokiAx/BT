...
var s = globalThis.__BT_PANEL_SHARED__.get("monaco-editor");
if (!s) throw Error("[Panel Shared] missing shared package: monaco-editor");
var c = s.CancellationTokenSource, l = s.Emitter, u = s.KeyCode, d = s.KeyMod, f = s.MarkerSeverity, p = s.MarkerTag, m = s.Position, h = s.Range, g = s.Selection, _ = s.SelectionDirection, v = s.Token, y = s.Uri, b = s.createWebWorker, x = s.css, S = s.editor, C = s.html, w = s.json, T = s.languages, E = s.lsp, D = s.typescript, O = /* @__PURE__ */ e({});
...
//#endregion
export { r as a, i, o as n, n as o, a as r, t as s, O as t };
